...
namespace SubmodularHeatEquation
{
    class MainClass
    {
        ...
        public static void Main(string[] args)
        {
            ...
            //Proposed_local_round("../../instance/dbpedia-writer_LCC.txt", 1); // Run Algorithm 1 for DBpedia Writers with seed node 0
            ...
            if (args.Length > 0) {
                ...
                Proposed_local_round(file1, id);
                //Proposed_local_round(file2, id);
            }
            else {
                //Proposed_local_round("/Users/qinqingliu/Documents/2020Fall/Hypergraph/python code/ubuntu_spc1_n5.txt", 1860);
                //Proposed_local_round("/Users/qinqingliu/Documents/2020Fall/Hypergraph/python code/ubuntu_c1_n5.txt", 1860);
                Proposed_local_round("/Users/qinqingliu/Documents/2020Fall/Hypergraph/python code/pr_c10_n5.txt", 1860);
            }
