...
def read_data(dataset):
    ...
    H = HyperGraph()
    if dataset == 'dbpedia':
        H.read_file_pr('./dataset/dbpedia/dbpedia-writer_LCC.txt')
    elif dataset == 'kdd':
        H.read_file_pr('./dataset/kdd/dblp_kdd_LCC.txt')
    elif dataset == 'archive':
        H.read_file_pr('./dataset/archive/opsahl-collaboration_LCC.txt')
    ...
    H.dataset = dataset
    try:
        os.mkdir('./dataset/{}/tmp'.format(dataset))
    except:
        pass
